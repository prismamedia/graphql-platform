...
import { IEdgeSelection, TFieldSelection } from './output/fields/fields';
...
describe('Node selection', () => {
  ...
  it.each([
    [
      'Article',
      undefined,
      `An error occurred at "Article" - expects a stringified fragment, got: undefined`,
    ],
    [
      'Article',
      null,
      `An error occurred at "Article" - expects a stringified fragment, got: null`,
    ],
    [
      'Article',
      `{ unknownField }`,
