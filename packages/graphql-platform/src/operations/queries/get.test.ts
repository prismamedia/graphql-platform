  ...
  it.each<[string, TMyContext | undefined, IGetIfExistsOperationArgs]>([
    ...
    async (nodeName, context, args) => {
      ...
      await expect(
        ...
        'At article - no "Article" node has been found given the following filter: ',
      );
  ...
  >([
    ...
    async (nodeName, context, args, connectorFindArgs) => {
      ...
      await expect(
        ...
        'An error has occurred at article - no "Article" node has been found given the following filter: ',
      );
