...
describe('DraftJS', () => {
  it.each<[input: any, error: string]>([
    ['', '"DraftJS" - Expects a plain object, got: '],
    [' ', '"DraftJS" - Expects a plain object, got: '],
    [' \n \t ', '"DraftJS" - Expects a plain object, got: '],
    [
      {
      ...
      '"DraftJS.blocks.0.entityRanges.0.key" - Expects a value among "myKey", got: \'myMissingKey\'',
    ],
    [
      {
        blocks: [
      ...
      '"DraftJS.blocks.0.entityRanges.0.key" - Expects a value among "0", got: 1',
    ],
