import { GraphQLSelectionNodeChildren, SuperSetOfNamedObject } from '@prismamedia/graphql-platform-utils';
...
export class UniqueSet extends SuperSetOfNamedObject<Unique> {
  ...
  public getComponentSet(): ComponentSet {
    return new ComponentSet().concat(...[...this].map(({ componentSet }) => componentSet));
  }
